...
\newcommand{\zwsel}[1]{
 \setlength{\fboxsep}{0pt} 
  \colorbox{green!10!white!100}{
    \ensuremath{{{\textcolor{Green}{{\triangleright}}}}{#1}{\textcolor{Green}{\triangleleft{\vphantom{\tehole}}}}}}
}
...
\newcommand{\paperclip}{\fontspec{Symbola}\symbol{"1F4CE}}
\newcommand{\suggestold}[2]{#1 \curvearrowright #2}
\newcommand{\suggest}[2]{#1 \ $\fontspec{Symbola}\symbol{"1F4CE}$\  #2}
\newcommand{\suggestStar}[2]{#1 \ $\fontspec{Symbola}\symbol{"1F4CE}*$\  #2} 
\newcommand{\numErrors}[1]{\# #1}
\newcommand{\errorCount}[2]{\numErrors{#1} = #2}

\newcommand{\construct}[1] { \ $\fontspec{Symbola}\char"1F528$ \ #1 \; }
\newcommand{\constructa}[1] { \ \mathtt{construct}\; #1}
